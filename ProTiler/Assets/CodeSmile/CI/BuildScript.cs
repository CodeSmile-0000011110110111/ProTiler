...
namespace CodeSmile.CI
{
	...
	public static class BuildScript
	{
		...
		public static void Build()
		{
			...
			// Custom build
			Build(buildTarget, options["customBuildPath"], options);
		}
		...
		private static void Build(BuildTarget buildTarget, string filePath, Dictionary<string, string> options)
		{
...
//                options = UnityEditor.BuildOptions.Development
		...
		private static void ReportSummary(BuildSummary summary) => Console.WriteLine(
			$"{Eol}" +
			$"###########################{Eol}" +
			$"#      Build results      #{Eol}" +
			$"###########################{Eol}" +
