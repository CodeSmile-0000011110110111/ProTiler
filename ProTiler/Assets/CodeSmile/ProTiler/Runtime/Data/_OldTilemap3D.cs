...
namespace CodeSmile.ProTiler.Data
{
	...
	public class _OldTilemap3D
	{
		...
		public _OldTilemap3D()
			: this(new ChunkSize(16, 16)) {}

		public _OldTilemap3D(ChunkSize chunkSize) => ChangeChunkSize(chunkSize);

		[ExcludeFromCodeCoverage]
		public override string ToString() => $"{nameof(_OldTilemap3D)}(Size: {ChunkSize}, Count: {Count}, TileCount: {TileCount})";
