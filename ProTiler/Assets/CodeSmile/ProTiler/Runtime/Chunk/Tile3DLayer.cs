...
namespace CodeSmile.ProTiler.Chunk
{
	...
	internal struct Tile3DLayer
	{
		...
		public Tile3D this[Int32 index]
		{
			get => m_Tiles[index];
		...
		/// </summary>
		public Int32 Capacity => IsInitialized ? m_Tiles.Length : 0;

		/// <summary>
		///     Returns true if the tile storage is not null. It can be initialized or null'ed via Resize().
		/// </summary>
		public Boolean IsInitialized => m_Tiles != null;
		...
		public void SetTiles(IEnumerable<Tile3DCoord> tileCoords, Int32 width)
		{
