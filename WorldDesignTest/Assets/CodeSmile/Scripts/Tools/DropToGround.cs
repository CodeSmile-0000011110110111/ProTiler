...
namespace CodeSmile
{
	...
	public class DropToGround : MonoBehaviour
	{
		...
		//[EHandles.FreeMoveHandle, EHandles.UseArrayHotkeys]
		[EHandles.Label(EHandles.Color.red)]
		[EHandles.DrawAAPolyline(color = Color.red)]
		[EHandles.PositionHandlePro, EHandles.UseArrayHotkeys, EHandles.UseLocalSpace]
		[SerializeField] private Vector3[] m_PointsTest;
